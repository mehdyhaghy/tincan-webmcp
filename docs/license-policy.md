...
The initial direct dependency set was checked on August 27, 2026. Vue, Vite, Vitest, the Vue Vite plugin, Vue TypeScript tooling, and Bun type definitions declare MIT. TypeScript and Playwright declare Apache-2.0.
